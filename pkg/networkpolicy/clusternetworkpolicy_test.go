...
func Test_ClusterNetworkPolicy_Evaluation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			adminEngine := NewPolicyEngine(podInfoProvider, []api.PolicyEvaluator{adminEvaluator})
			...
			baselineEngine := NewPolicyEngine(podInfoProvider, []api.PolicyEvaluator{baselineEvaluator})
